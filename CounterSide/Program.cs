...
namespace Cs.Engine.Network.Buffer.Detail
{
	public static class Crypto
	{
		...
		public static readonly ulong[] maskList = { 0x539B9E651C6932B7, 0x81E2FE752C157CE1, 0x0CC5CB98224842A7, 0x61B655B38D3A887C };
...
public class BetterStreamingAssets
{
	...
	public class NKCAssetbundleCryptoStream : FileStream
	{
		...
		public NKCAssetbundleCryptoStream(string path, FileMode mode,
										   FileAccess access) : base(path, mode,
													   access)
		{
			decryptedArray = new byte[212];
			decryptSize = Math.Min(Length, 212);
